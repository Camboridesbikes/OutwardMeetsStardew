...
namespace RPGCharacterAnims
{
    ...
    public class _CharacterController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            SetHandler(HandlerTypes.Combat,new Combat());
        ...
        /// 
        /// Modify from side attacks to light and heavy attacks
        /// 
        /// </summary>
        ...
        public void Attack(int attackNumber, AttackWeight attackWeight,  float duration)
        {
            int combo = comboSystem.GetComboStep();

            comboSystem.Attack();
	        animator.SetAttackWeight(attackWeight);
            animator.SetAttackCombo(combo);
			_isAttacking = true;
