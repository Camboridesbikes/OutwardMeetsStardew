...
namespace RPGCharacterAnims
{
	...
	public class AnimationData
	{
		...
		public static float AttackDuration(AttackWeight attackWeight, Weapon weapon, int attackNumber)
		{
			var duration = 1f;

			switch (attackWeight)
			{
				case AttackWeight.Light:                        // Unspecified (2-Handed Weapons)
					switch (weapon)
					{
						...
						case Weapon.Item:
							...
							break;              // L Pistol (1-3)
						default:
							Debug.LogError("RPG Character: no weapon number " + weapon + " for LightAttack");
							break;
					}
					break;
				case AttackWeight.Heavy:                    // Right Side
					switch (weapon)
					{
						case Weapon.TwoHandSword:
							duration = 1.1f;
						...
						case Weapon.Item:
							...
							break;              // L Pistol (1-3)
						default:
							Debug.LogError("RPG Character: no weapon number " + weapon + " for HeavyAttack");
							break;
					}
					break;
			}
        ...
        public static int AttackNumber(AttackWeight attackWeight, Weapon weapon)
        {
