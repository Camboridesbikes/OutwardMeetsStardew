...
namespace RPGCharacterAnims.Extensions
{
    ...
    public static class AnimatorExtensions
    {
        ...
        public static void SetAttackWeight(this Animator animator, AttackWeight attackWeight)
        { animator.SetInteger(AnimationParameters.AttackWeight, (int)attackWeight); }

        public static void SetAttackCombo(this Animator animator, int combo)
        { animator.SetInteger(AnimationParameters.Combo, combo); }
