...
namespace RPGCharacterAnims.Actions
{
    ...
    public interface IActionHandler
    {
        ...
        bool CanStartAction(_CharacterController controller);
        ...
        void StartAction(_CharacterController controller, object context);
        ...
        /// <param name="controller">RPGCharacterController instance.</param>
        /// <returns></returns>
        bool CanEndAction(_CharacterController controller);
        ...
        void EndAction(_CharacterController controller);
