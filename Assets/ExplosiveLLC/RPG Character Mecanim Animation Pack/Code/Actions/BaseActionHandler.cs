...
namespace RPGCharacterAnims.Actions
{
    ...
    public abstract class BaseActionHandler<TContext> : IActionHandler
    {
        ...
        /// </summary>
        public abstract bool CanStartAction(_CharacterController controller);
        ...
        public virtual void StartAction(_CharacterController controller, object context)
        {
        ...
        protected abstract void _StartAction(_CharacterController controller, TContext context);

        /// <summary>
        /// Placeholder method, see IActionHandler#CanEndAction.
        /// </summary>
        /// <returns></returns>
        public abstract bool CanEndAction(_CharacterController controller);
        ...
        /// </summary>
        /// <param name="controller">RPGCharacterController instance.</param>
        public virtual void EndAction(_CharacterController controller)
        {
        ...
        /// </summary>
        /// <param name="controller">RPGCharacterController instance.</param>
        protected abstract void _EndAction(_CharacterController controller);
    }
}